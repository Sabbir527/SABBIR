...
def banner():
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : SABBIR                   %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : https://github.com/Sabbir527  %s║"%(Z,B,Z))
	print("%s║%s  What's app : https://chat.whatsapp.com/BBvkSBch1aLLOtWJFtos2s  %s║"%(Z,B,Z))
	print("%s║%s  Version  : %s0.1                          %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
